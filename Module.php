...
class Module extends AbstractModule
{
    ...
    public function install(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $connection->exec("ALTER TABLE fedora_item ADD CONSTRAINT FK_D02FFFF9126F525E FOREIGN KEY (item_id) REFERENCES item (id);");
    ...
    {
        $connection = $serviceLocator->get('Omeka\Connection');
        $connection->exec("ALTER TABLE fedorar_item DROP FOREIGN KEY FK_D02FFFF9126F525E;");
